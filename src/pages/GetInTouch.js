    ...
    return (
      <section className="get-in-touch">
        <Container fluid className="display-not-on-phone d-flex">
          ...
          <Col md={7} className="d-flex flex-column">
            <Container className="m-auto p-3 bg-red" style={{ borderRadius: "20px", maxWidth: "650px" }}>
              <form data-netlify="true" netlify name="contactForm" method="post" onSubmit={this.handleFormSubmit}>
        ...
        <Container fluid className="display-on-phone d-flex flex-column">
          ...
          <Container className="m-auto p-3 bg-red" style={{ borderRadius: "20px", maxWidth: "650px" }}>
            <form data-netlify="true" netlify name="contactForm" method="post" onSubmit={this.handleMobileFormSubmit}>
              <TextField
                id="filled-name"
                label="Your Name"
                type="text"
